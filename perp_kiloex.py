...
def get_positions(config, product_ids):
    ...
    positions_raw = view_contract_w3.functions.getPositions(wallet_address, product_ids).call()
    positions = []
...
def get_products(config, ids):
    ...
    products_raw = view_contract_w3.functions.getProductsV2(wallet_address, ids).call()
    products = []
